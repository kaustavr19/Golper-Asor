...
const sundaySuspenseWriters: WriterProfile[] = [
  ...
  { id: "saikat", label: "Saikat Mukhopadhyay", bengaliLabel: "সৈকত মুখোপাধ্যায়", artwork: detectiveArtwork },
  { id: "bram-stoker", label: "Bram Stoker", bengaliLabel: "ব্রাম স্টোকার", artwork: horrorArtwork },
  { id: "sayak-aman", label: "Sayak Aman", bengaliLabel: "সায়ক আমান", artwork: horrorArtwork },
  { id: "samaresh-majumdar", label: "Samaresh Majumdar", bengaliLabel: "সমরেশ মজুমদার", artwork: adventureArtwork },
  { id: "sujan-dasgupta", label: "Sujan Dasgupta", bengaliLabel: "সুজন দাশগুপ্ত", artwork: detectiveArtwork },
  { id: "gk-chesterton", label: "G. K. Chesterton", bengaliLabel: "জি. কে. চেস্টারটন", artwork: detectiveArtwork },
  { id: "syed-mustafa-siraj", label: "Syed Mustafa Siraj", bengaliLabel: "সৈয়দ মুস্তাফা সিরাজ", artwork: detectiveArtwork },
  { id: "taradas", label: "Taradas Bandyopadhyay", bengaliLabel: "তারাদাস বন্দ্যোপাধ্যায়", artwork: taranathArtwork },
  { id: "koushik-ray", label: "Koushik Ray", bengaliLabel: "কৌশিক রায়", artwork: detectiveArtwork },
  { id: "ruskin-bond", label: "Ruskin Bond", bengaliLabel: "রাসকিন বন্ড", artwork: writersArtwork },
  { id: "edgar-allan-poe", label: "Edgar Allan Poe", bengaliLabel: "এডগার অ্যালান পো", artwork: horrorArtwork },
];
...
export const CHANNELS: StoryChannel[] = [
  {
    ...
    collections: [
      ...
      { id: "ss-eken", label: "Eken Babu", bengaliLabel: "একেনবাবু", sourceWriter: "Sujan Dasgupta", writerId: "sujan-dasgupta", kind: "character", playlistId: "PLq71IJk8mCV6j59qmuk93Se_W7k9bfAcu", videoCount: 2, artwork: detectiveArtwork },
      ...
      { id: "ss-bankim-selected", label: "Sunday Suspense Stories", bengaliLabel: "বঙ্কিমচন্দ্রের গল্পসমগ্র", sourceWriter: "Bankim Chandra Chattopadhyay", writerId: "bankim", kind: "writer", playlistId: "PLq71IJk8mCV7Lx6UMeabgGXckH9RzDzBo", videoCount: 0, artwork: writersArtwork },
      { id: "ss-bankim-durgeshnandini", label: "Durgeshnandini", bengaliLabel: "দুর্গেশনন্দিনী", sourceWriter: "Bankim Chandra Chattopadhyay", writerId: "bankim", kind: "writer", playlistId: "PLq71IJk8mCV6OHlTC-6PjeSsOKXwduNsZ", videoCount: 0, artwork: adventureArtwork },
      { id: "ss-satyajit-suspense", label: "Sunday Suspense Stories", bengaliLabel: "সত্যজিৎ রায়ের গল্প", sourceWriter: "Satyajit Ray", writerId: "satyajit", kind: "writer", playlistId: "PLq71IJk8mCV5vmwzOzycUTzCr251mjMK7", videoCount: 0, artwork: feludaArtwork },
      { id: "ss-saikat-umashankar", label: "Umashankar Choubey", bengaliLabel: "উমাশঙ্কর চৌবে", sourceWriter: "Saikat Mukhopadhyay", writerId: "saikat", kind: "writer", playlistId: "PLq71IJk8mCV4XP2LNC8nDMIdSbElrcGZ6", videoCount: 0, artwork: detectiveArtwork },
      { id: "ss-saikat-special", label: "Crime, Horror & Adventure", bengaliLabel: "অপরাধ, ভয় ও অভিযান", sourceWriter: "Saikat Mukhopadhyay", writerId: "saikat", kind: "writer", playlistId: "PLq71IJk8mCV4ktIjV3sPuDdmscfgVWI-A", videoCount: 0, artwork: horrorArtwork },
      { id: "ss-bram-stoker-dracula", label: "Dracula", bengaliLabel: "ড্রাকুলা", sourceWriter: "Bram Stoker", writerId: "bram-stoker", kind: "writer", playlistId: "PLq71IJk8mCV7EeHC8HpcU5iwrru_4bbB2", videoCount: 0, artwork: horrorArtwork },
      { id: "ss-sayak-aman", label: "Sunday Suspense Stories", bengaliLabel: "সানডে সাসপেন্স গল্পসমগ্র", sourceWriter: "Sayak Aman", writerId: "sayak-aman", kind: "writer", playlistId: "PLq71IJk8mCV4UnuNY3v6DCiZxkMlFUUJ8", videoCount: 0, artwork: horrorArtwork },
      { id: "ss-shirshendu-adbhuture", label: "Adbhuture Series", bengaliLabel: "অদ্ভুতুড়ে সিরিজ", sourceWriter: "Shirshendu Mukhopadhyay", writerId: "shirshendu", kind: "writer", playlistId: "PLq71IJk8mCV6e2FTppaGBXXthImLYI9aV", videoCount: 0, artwork: writersArtwork },
      { id: "ss-shirshendu-special", label: "Ghosts, Fantasy & Mystery", bengaliLabel: "ভূত, কল্পনা ও রহস্য", sourceWriter: "Shirshendu Mukhopadhyay", writerId: "shirshendu", kind: "writer", playlistId: "PLq71IJk8mCV4c_iUJFZAOZ0Jw1oevH8R_", videoCount: 0, artwork: writersArtwork },
      { id: "ss-sunil-suspense", label: "Kakababu, Sci-Fi & Horror", bengaliLabel: "কাকাবাবু, কল্পবিজ্ঞান ও ভয়", sourceWriter: "Sunil Gangopadhyay", writerId: "sunil", kind: "writer", playlistId: "PLq71IJk8mCV7iDjIK9cNGkv2vMKJBuGrr", videoCount: 0, artwork: kakababuArtwork },
      { id: "ss-samaresh-arjun", label: "Arjun", bengaliLabel: "অর্জুন", sourceWriter: "Samaresh Majumdar", writerId: "samaresh-majumdar", kind: "writer", playlistId: "PLq71IJk8mCV57YXuwtRvVmRSp2Swx15Cv", videoCount: 0, artwork: adventureArtwork },
      { id: "ss-chesterton-father-brown", label: "Father Brown Mysteries", bengaliLabel: "ফাদার ব্রাউন রহস্য", sourceWriter: "G. K. Chesterton", writerId: "gk-chesterton", kind: "writer", playlistId: "PLq71IJk8mCV5w7zw5LaUtQDqypHsACOEi", videoCount: 0, artwork: detectiveArtwork },
      { id: "ss-siraj-colonel", label: "Colonel", bengaliLabel: "কর্নেল", sourceWriter: "Syed Mustafa Siraj", writerId: "syed-mustafa-siraj", kind: "writer", playlistId: "PLq71IJk8mCV5LezqJi_oarF7h_a5aoH-T", videoCount: 0, artwork: detectiveArtwork },
      { id: "ss-siraj-special", label: "Selected Stories", bengaliLabel: "নির্বাচিত গল্প", sourceWriter: "Syed Mustafa Siraj", writerId: "syed-mustafa-siraj", kind: "writer", playlistId: "PLq71IJk8mCV5Z69saIx2ZMUXF279vbD3_", videoCount: 0, artwork: detectiveArtwork },
      { id: "ss-taradas-taranath", label: "Taranath Tantrik Stories", bengaliLabel: "তারানাথ তান্ত্রিকের গল্প", sourceWriter: "Taradas Bandyopadhyay", writerId: "taradas", kind: "writer", playlistId: "PLq71IJk8mCV4EMJ43c1iPBegs03lxCCt-", videoCount: 0, artwork: taranathArtwork },
      { id: "ss-saradindu-baroda", label: "Baroda: The Bhootanweshi", bengaliLabel: "বরদা: ভূতান্বেষী", sourceWriter: "Saradindu Bandyopadhyay", writerId: "saradindu", kind: "writer", playlistId: "PLq71IJk8mCV6w6kAXHyUpRTKgrjgwYWqq", videoCount: 0, artwork: horrorArtwork },
      { id: "ss-saradindu-selected-epics", label: "Byomkesh, Baroda & Historical Epics", bengaliLabel: "ব্যোমকেশ, বরদা ও ঐতিহাসিক কাহিনি", sourceWriter: "Saradindu Bandyopadhyay", writerId: "saradindu", kind: "writer", playlistId: "PLq71IJk8mCV4ln03bJgRdxTw7s_GJoG5Z", videoCount: 0, artwork: byomkeshArtwork },
      { id: "ss-saradindu-tungabhadra", label: "Tungabhadrar Teere", bengaliLabel: "তুঙ্গভদ্রার তীরে", sourceWriter: "Saradindu Bandyopadhyay", writerId: "saradindu", kind: "writer", playlistId: "PLq71IJk8mCV7fDSXk6vX141ln3c22FLP2", videoCount: 0, artwork: adventureArtwork },
      { id: "ss-koushik-prokhor", label: "Prokhor Rudra", bengaliLabel: "প্রখর রুদ্র", sourceWriter: "Koushik Ray", writerId: "koushik-ray", kind: "writer", playlistId: "PLq71IJk8mCV7w9wMOPEzBthrPwpNdiGwM", videoCount: 0, artwork: detectiveArtwork },
      { id: "ss-bibhutibhushan-chander-pahar", label: "Chander Pahar", bengaliLabel: "চাঁদের পাহাড়", sourceWriter: "Bibhutibhushan Bandyopadhyay", writerId: "bibhutibhushan", kind: "writer", playlistId: "PLq71IJk8mCV63_A846TE3B-hGTTxe8d-Y", videoCount: 0, artwork: adventureArtwork },
      { id: "ss-rabindranath-suspense", label: "Suspense Stories", bengaliLabel: "রহস্য ও সাসপেন্সের গল্প", sourceWriter: "Rabindranath Tagore", writerId: "rabindranath", kind: "writer", playlistId: "PLq71IJk8mCV5ALg9CswKncT_suQj1gxCL", videoCount: 0, artwork: writersArtwork },
      { id: "ss-ruskin-bond", label: "Sunday Suspense Stories", bengaliLabel: "সানডে সাসপেন্স গল্পসমগ্র", sourceWriter: "Ruskin Bond", writerId: "ruskin-bond", kind: "writer", playlistId: "PLq71IJk8mCV71kuWwBS7PFM6Wq6nYih13", videoCount: 0, artwork: writersArtwork },
      { id: "ss-edgar-allan-poe", label: "Crime & Horror Classics", bengaliLabel: "অপরাধ ও ভয়ের ক্লাসিক", sourceWriter: "Edgar Allan Poe", writerId: "edgar-allan-poe", kind: "writer", playlistId: "PLq71IJk8mCV4quh0oDUCiVcKbEvRjQIzo", videoCount: 0, artwork: horrorArtwork },
